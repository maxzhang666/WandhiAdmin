...
return [
    ...
    // 应用映射（自动多应用模式有效）
    'app_map'          => [
        Env::get('wandhi.admin', 'admin') => 'admin',
    ],
    // 后台别名
    'admin_alias_name' => Env::get('wandhi.admin', 'admin'),
    // 域名绑定（自动多应用模式有效）
    'domain_bind'      => [],
    ...
    // 错误显示信息,非调试模式有效
    'error_message'    => '出了点问题，要不一会试试？',
    // 显示错误信息
    'show_error_msg'   => true,
    // 静态资源上传到OSS前缀
    'oss_static_prefix'   => Env::get('wandhi.oss_static_prefix', 'static_wandhi'),
];
